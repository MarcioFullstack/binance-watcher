...
export const BalanceCards = () => {
  ...
  console.log('BalanceCards render:', { hasData: !!data, isLoading, error: error?.message });
  ...
  // If there's a keys error but no data, show a placeholder while the alert is displayed above
  if (isKeysError && !data) {
    return (
